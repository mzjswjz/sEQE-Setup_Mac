...
#        print(self.Si_cal)
        ...
        # Path to USB connections NOTE: Change these if necessary
...
# -----------------------------------------------------------------------------------------------------------
    ...
    #     ret = False
    #     self.p.timeout = 4
    #     shouldbEOk = self.p.readlines()
    #     print(shouldbEOk)
    #     if len(shouldbEOk)>1:
    #         if (shouldbEOk[5] == 'ok\r\n'.encode()) or (shouldbEOk[5] == ' ok\r\n'.encode()) or (shouldbEOk[5] == '  ok\r\n'.encode()):
    #             ret = True
    #         else:
    #             print('Connection to Monochromator Could Not Be Established')
    #     else:
    #         if shouldbEOk[0].endswith('ok\r\n'.encode()):
    #             ret = True
    #         else:
    #             print('Connection to Monochromator Could Not Be Established')
    #     self.p.timeout = 0
    ...
    def connectToLockin(self):    
        ...
        # Find device and open connection to ziServer 
        dev = 'hf2-dev838'
